...
{
    public class DropoutBackprop : SupervisedLearner
    {
        ...
        public override void Init(int inputDimension, int outputDimension)
        {
            ...
            Init(inputDimension, inputDimension / 2, outputDimension);
        ...
        public float TrainMiniBatch(Dataset data, IEnumerable<int> indices)
        {
            ...
            Console.WriteLine(weights[0][layers[0].Length / 2, layers[1].Length / 2]);
            Console.WriteLine(weights[1][layers[1].Length / 2, layers[2].Length / 2]);
